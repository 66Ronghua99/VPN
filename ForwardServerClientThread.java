...
public class ForwardServerClientThread extends Thread
{
    ...
    public SessionEncrypter se;
    public SessionDecrypter sd;
     ...
     */
    public ForwardServerClientThread(Socket aClientSocket, String serverhost, int serverport, SessionEncrypter se, SessionDecrypter sd)
    {
     ...
     * A server socket is created later by run() method.
     */
    public ForwardServerClientThread(ServerSocket listensocket, String serverhost, int serverport, SessionEncrypter se, SessionDecrypter sd) throws IOException
    {
    ...
    public void run()
    {
        try {
           ...
           if (mListenSocket != null) {
               ...
               mClientHostPort = mClientSocket.getInetAddress().getHostAddress() + ":" + mClientSocket.getPort();
               //get the host and port of the client
           }

           try {
               mServerSocket = new Socket(mServerHost, mServerPort);//ForwardClient connect to ForwardServer
           } catch (Exception e) {
           ...
           //here information transferred need to be encrypted in session key
           ...
           ForwardThread clientForward = new ForwardThread(this, clientIn, serverOut,!isEncrypted);
           ForwardThread serverForward = new ForwardThread(this, serverIn, clientOut,isEncrypted);
